...
const Home = () => {
  ...
  return (
    <div>
      <Carousel />
      <Category />
      <div className='w-[90%] mx-auto text-[#EAEAEA]'>
        <div className='grid grid-cols-4 gap-2 font-sans'>
          {products.map((item, i) => (
            <div key={i} className='mb-4 bg-[#e3c5ff6b] shadow-xl hover:transform hover:scale-[1.01] ease-in-out duration-300 rounded-lg'>
